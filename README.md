...
This repository contains the Phase 0 architecture foundation and Phase 1 minimum viable editor.
...
- Request-generation checks that prevent stale previews from replacing newer results
...
2. Adjust controls or choose a preset. Slider changes are debounced and previews are generated from a cached copy capped at 1600 pixels.
3. Use **Compare** to drag between the original and edited previews.
